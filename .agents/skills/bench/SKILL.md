...
name: bench
description: >-
  Run comparative benchmarks and flag regressions. Use when the user says "benchmark", "run benchmarks", "perf comparison", or "/bench".
---
...
(detect it with `.agents/tools/facts.sh`, run it under `.agents/tools/watch.sh`).
