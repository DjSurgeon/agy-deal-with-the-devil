...
DO NOT add a route before reading the nearest existing handler and `.agents/rules/api-convention.md`.
...
- Run the relevant check through the project's task runner (detect it with `.agents/tools/facts.sh`).
