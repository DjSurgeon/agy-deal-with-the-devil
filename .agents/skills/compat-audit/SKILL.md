...
name: compat-audit
description: >-
  Full behavioral parity audit against a reference spec, endpoint by endpoint. Use when the user says "parity audit", "full compatibility audit", or "/compat-audit".
---
