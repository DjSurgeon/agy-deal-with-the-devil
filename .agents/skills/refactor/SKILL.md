...
name: refactor
description: >-
  Deep refactor at the strictest standard for the technology. Use when the user says "refactor this", "deep refactor", "clean up code", or "/refactor".
---


Technology: the user's request

Read and apply ALL of the following before touching any code:

1. GEMINI.md section: refactor-common.md (always)
2. GEMINI.md section: refactor-<technology>.md (for the specified tech)
