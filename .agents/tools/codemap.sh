...
# instead of re-reading every file. Caches to .agents/cache/codemap.md.
#
...
build_summary() {
  ...
  echo
  echo "_Drill in: \`.agents/tools/codemap.sh\` (full table) or \`rg <symbol> \$(.agents/tools/codemap.sh | …)\`._"
}
